  ...
  return (
    <div className="bg-black min-h-screen flex flex-col text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-3 bg-black shadow-md sticky top-0 z-50">
        <a href="/" className="text-2xl font-bold text-gray-300 hover:underline">
      ...
      <div className="flex flex-1">
        ...
        <div>
          ...
          <p className="text-sm text-gray-300">
            This is a 3D point cloud model of Linkou District, New Taipei City.（林口區）
        ...
        <main className="flex-1 relative h-screen">
          <Canvas className="absolute top-0 left-0 w-full h-full" camera={{ position: [0, 0, 20], fov: 60 }}>
            ...
            <Suspense fallback={null}>
              {activePart === 1 ? (
                <CenteredModelPLY url="/ply/linco_cd_densified_point_cloud_part_4_part1.ply" />
              ) : (
                <CenteredModelPLY url="/ply/linco_cd_densified_point_cloud_part_4_part2.ply" />
              )}
            </Suspense>
      ...
      <footer className="footer bg-dark text-light py-3 text-center">
        <p className="mb-1 small">
          📧 Email: <a href="mailto:tingccc93@gmail.com">tingccc93@gmail.com</a> | 🔗 GitHub:{" "}
          <a href="https://github.com/SakiiiCHU" target="_blank" rel="noopener noreferrer">
            SakiiiCHU
          </a>
        </p>
        <p className="small fw-light mb-0">
          ©2024 Ting-Chen Chu. This project is for educational and demonstration purposes only, non-commercial use.
        </p>
      </footer>
    </div>
  )
